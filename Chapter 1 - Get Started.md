...
- std::cout과 std::endl은 <iostream>에 정의되어 있습니다. std::cout은 화면에 텍스트를 출력하는 출력 스트림입니다. std::endl은 한 줄을 끝냅니다. 또한 특수 문자 \n을 사용해 새 줄로 이동할 수 있습니다.
- 연산자 <<는 std::cout과 같은 출력 스트림에 객체를 전달해 출력 동작을 수행하는데 사용합니다.
